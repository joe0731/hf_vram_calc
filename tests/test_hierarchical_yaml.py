...
def test_hierarchical_yaml():
    ...
    test_config = {
        ...
        "lora_config": {"max_lora_rank": 128, "lora_dir": "/path/to/lora"},
        "kv_cache_config": {"dtype": "fp8", "mamba_ssm_cache_dtype": "fp16"},
        "quant_config": {"quant_algo": "fp8", "kv_cache_quant_algo": "fp8"},
        "performance_options": {"cuda_graphs": True, "multi_block_mode": True},
        "decoding_config": {"medusa_choices": [[0, 1], [0, 2], [1, 2]]},
...
def test_quant_algo_mapping():
    ...
    test_config = {"quant_config": {"quant_algo": "bf16"}}
